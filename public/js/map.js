...
// 위도
var lat_line= [37.69173846, 37.64577895, 37.60262058, 37.55674696, 37.51063517, 37.46494092, 37.42198141];
// 경도
...
function showGrid(time) {
    ...
    for (var idx = 0; idx < grid_count; idx++) {
        ...
        var fillOpacity = (fillColor === '#FFFFFF') ? 0 : 0.6; // 조건에 따라 fillOpacity 설정
